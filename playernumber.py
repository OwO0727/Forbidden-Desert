...
def main(root, bg, np, bp):
    ...
    canvas1.create_text(640, 220, text="How Many Players?", fill="black", font=('Helvetica 20 bold underline'))
    canvas1.pack()
    ...
    c.place(x=windowDims[0] // 2 - 50, y=600, width=100, height=60)
    b = Button(root, text="Begin!", command = startGame)
    b.place(x=windowDims[0] // 2 -50, y=windowDims[1] // 2-0 , width=100, height=50)
