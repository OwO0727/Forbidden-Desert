...
def main(root,bg,np):
    ...
    startButton = Button(root, text="Start Game", bg="#bf9000", command=startGame)
    startButton.place(x=windowDims[0]//2-75, y=windowDims[1]//2-25, width=150, height=50)

    rulesButton = Button(root, text="Rules", bg="#bf9000", command=startRulesMenu)
    rulesButton.place(x=windowDims[0]//2-25, y=windowDims[1]//2+50, width=50, height=20)

    quitButton = Button(root, text="Quit", bg="#bf9000", command=lambda: root.destroy())
