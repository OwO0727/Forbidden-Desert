...
def main(window, bgimg, playerTypes, func, num, bp):
    ...
    def playerSelectScrn(playerCount: int):
        ...
        button["back"] = tk.Button(window, text="Back", bg="#bf9000", width=21)
        ...
        button["confirm"] = tk.Button(window, text="Confirm", bg="#bf9000", width=21)
        ...
        button["quit"] = tk.Button(window, text="Cancel", bg="#bf9000", width=21)
        button["quit"].place(x=windowDims[0]//2-300, y=windowDims[1]//2+(len(playerTypes)//maxRow*150))
        button["quit"].config(command=lambda: quit())
        button["rdm"] = tk.Button(window, text="Random", bg="#bf9000", width=21, command=lambda: selectR())
